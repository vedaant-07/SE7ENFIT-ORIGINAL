...
// These OAuth client IDs are public identifiers, not secrets. Environment
// variables can still override them for future debug or iOS builds.
...
export const GOOGLE_ANDROID_CLIENT_ID =
  runtimeEnv.EXPO_PUBLIC_GOOGLE_ANDROID_CLIENT_ID || '10666408411-0iaj88pvijfgcl4it0cff6dm62326h1d.apps.googleusercontent.com';
